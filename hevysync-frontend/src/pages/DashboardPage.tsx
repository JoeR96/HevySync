...
import { Calendar, TrendingUp, Dumbbell, Target, Clock, Award, Activity, ChevronRight } from 'lucide-react';
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                {activeWorkout && activeActivity && (
                  <p className="text-indigo-100 text-sm mt-1">Week {getProp(activeActivity, 'week')}, Day {getProp(activeActivity, 'day')}</p>
                )}
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg mb-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Week {getProp(activeActivity, 'week')} of {getProp(activeActivity, 'workoutsInWeek')} • Day {getProp(activeActivity, 'day')}
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {exercises.slice(0, 6).map((exercise: any) => {
                ...
                return (
                  <div key={exerciseId} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
